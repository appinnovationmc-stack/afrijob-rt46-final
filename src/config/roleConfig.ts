...
export const ROLE_CONFIG: Record<OrganisationRole, RoleConfig> = {
  owner: { role: 'owner', defaultLanding: landingFor('owner'), dashboardKey: 'owner', nav: [NAV.workspace, NAV.intelligence, NAV.procurement, NAV.assets, NAV.notifications, NAV.admin_team], allowedModules: ['workspace','intelligence','procurement','assets','notifications','admin_team'] },
  ...
  procurement_officer: { role: 'procurement_officer', defaultLanding: landingFor('procurement_officer'), dashboardKey: 'procurement_officer', nav: [NAV.procurement, NAV.assets, NAV.documents, NAV.notifications], allowedModules: ['procurement','assets','documents','notifications'] },
