...
export function JobReportDocument({
  ...
  return (
    <Document title={`AfriOps Report — ${job.vehicle_registration}`}>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.footer} fixed>
          <Text style={styles.footerText}>Generated {formatDate(generatedAt)} · AfriOps Job Report</Text>
          <Text style={styles.footerText}>Generated by AfriOps</Text>
        </View>
      </Page>
    </Document>
  );
